    ...
    public function __construct()
    {
        ...
        add_action('admin_notices', function () {
            ...
            <div class="notice notice-warning fluentsmtp_urgent is-dismissible">
                <p>
                    FluentRunSmtp Plugin may not work properly. Looks like your Authentication unique keys and salts are changed. <a href="<?php echo esc_url(admin_url('options-general.php?page=fluent-mail#/connections')); ?>"><b>Reconfigure SMTP Settings</b></a>
                </p>
            </div>
            <?php
        });
