...
class TransStrings
{
    public static function getStrings()
    {
        return [
            ...
            'FluentRunSmtp does not store your email notifications data.' => __('FluentRunSmtp does not store your email notifications data.', 'fluent-smtp'),
            'FluentRunSmtp does not store your email notifications data. ' => __('FluentRunSmtp does not store your email notifications data. ', 'fluent-smtp'),
            'FluentRunSmtp is built using the following open-source libraries and software' => __('FluentRunSmtp is built using the following open-source libraries and software', 'fluent-smtp'),
            ...
            '__ABOUT_BY' => __('FluentRunSmtp is free and will be always free. This is our pledge to WordPress community from WPManageNinja LLC.', 'fluent-smtp'),
            '__ABOUT_COMMUNITY' => __('FluentRunSmtp is powered by community. We listen to our community users and build products that add value to businesses and save time.', 'fluent-smtp'),
            '__ABOUT_INTRO' => __('is a free and open-source WordPress Plugin. Our mission is to provide the ultimate email delivery solution with your favorite Email sending service. FluentRunSmtp is built for performance and speed.', 'fluent-smtp'),
            '__ABOUT_JOIN' => __('Join our communities and participate in great conversations.', 'fluent-smtp'),
            '__ABOUT_POWERED' => __('FluentRunSmtp is powered by its users like you. Feel free to contribute on Github. Thanks to all of our contributors.', 'fluent-smtp'),
            ...
            '__DISCORD_NOTIFICATION_ENABLED' => __('Your FluentRunSmtp plugin is currently integrated with your Discord Channel. Receive timely notifications on Discord for any email sending issues from your website. This ongoing connection ensures you\'re always informed about your email delivery status.', 'fluent-smtp'),
            ...
            '__SLACK_NOTIFICATION_ENABLED' => __('Your FluentRunSmtp plugin is currently integrated with your Slack Channel. Receive timely notifications on Slack for any email sending issues from your website. This ongoing connection ensures you\'re always informed about your email delivery status.', 'fluent-smtp'),
            ...
            '__TELEGRAM_NOTIFICATION_ENABLED' => sprintf(__('Your FluentRunSmtp plugin is currently integrated with Telegram. Receive timely notifications from %s on Telegram for any email sending issues from your website. This ongoing connection ensures you\'re always informed about your email delivery status.', 'fluent-smtp'), '<a target="_blank" rel="noopener" href="https://t.me/fluentsmtp_bot">@fluentsmtp_bot</a>'),
            '__TELE_INTRO' => sprintf(__('Get real-time notifications on your %1$s for any email sending failures. Configure notifications with FluentRunSmtp\'s official %2$s to start receiving real-time alerts.', 'fluent-smtp'), '<a target="_blank" rel="noopener" href="https://telegram.org/">Telegram Messenger</a>', '<a target="_blank" rel="noopener" href="https://t.me/fluentsmtp_bot">telegram bot</a>'),
            ...
            '__wizard_sub' => __('Thank you for installing FluentRunSmtp - The ultimate SMTP & Email Service Connection Plugin for WordPress', 'fluent-smtp'),
            '__wizard_title' => __('Welcome to FluentRunSmtp', 'fluent-smtp'),
            ...
            'write a review for FluentRunSmtp' => __('write a review for FluentRunSmtp', 'fluent-smtp')
];
    }
}