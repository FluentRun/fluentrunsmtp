...
return [
    ...
    'providers'   => [
        'smtp'        => [
            ...
            'note'     => '<a href="https://fluentsmtp.com/docs/set-up-fluent-smtp-with-any-host-or-mailer/" target="_blank" rel="noopener">' . __('Read the documentation', 'fluent-smtp') . '</a>' . __(' for how to configure any SMTP with FluentRunSmtp.', 'fluent-smtp')
        ],
        'ses'         => [
            'key'      => 'ses',
            ...
            'note'     => '<a href="https://fluentsmtp.com/docs/set-up-amazon-ses-in-fluent-smtp/" target="_blank" rel="noopener">' . __('Read the documentation', 'fluent-smtp') . '</a>' . __(' for how to configure Amazon SES with FluentRunSmtp.', 'fluent-smtp')
        ],
        'mailgun'     => [
            'key'      => 'mailgun',
            ...
            'note'     => '<a href="https://fluentsmtp.com/docs/configure-mailgun-in-fluent-smtp-to-send-emails/" target="_blank" rel="noopener">' . __('Read the documentation', 'fluent-smtp') . '</a>' . __(' for how to configure Mailgun with FluentRunSmtp.', 'fluent-smtp')
        ],
        'sendgrid'    => [
            'key'      => 'sendgrid',
            ...
            'note'     => '<a href="https://fluentsmtp.com/docs/set-up-the-sendgrid-driver-in-fluent-smtp/" target="_blank" rel="noopener">' . __('Read the documentation', 'fluent-smtp') . '</a>' . __(' for how to configure SendGrid with FluentRunSmtp.', 'fluent-smtp')
        ],
        'sendinblue'  => [
            'key'      => 'sendinblue',
            ...
            'note'     => '<a href="https://fluentsmtp.com/docs/setting-up-sendinblue-mailer-in-fluent-smtp/" target="_blank" rel="noopener">' . __('Read the documentation', 'fluent-smtp') . '</a>' . __(' for how to configure Sendinblue with FluentRunSmtp.', 'fluent-smtp')
        ],
        'sparkpost'   => [
            'key'      => 'sparkpost',
            ...
            'note'     => '<a href="https://fluentsmtp.com/docs/configure-sparkpost-in-fluent-smtp-to-send-emails/" target="_blank" rel="noopener">' . __('Read the documentation', 'fluent-smtp') . '</a>' . __(' for how to configure SparkPost with FluentRunSmtp.', 'fluent-smtp')
        ],
        'pepipost'    => [
            'key'      => 'pepipost',
            ...
            'note'     => '<a href="https://fluentsmtp.com/docs/set-up-the-pepipost-mailer-in-fluent-smtp/" target="_blank" rel="noopener">' . __('Read the documentation', 'fluent-smtp') . '</a>' . __(' for how to configure Netcore (formerly Pepipost) with FluentRunSmtp.', 'fluent-smtp')
        ],
        'postmark'    => [
            'key'      => 'postmark',
            ...
            'note'     => '<a href="https://fluentsmtp.com/docs/configure-postmark-in-fluent-smtp-to-send-emails/" target="_blank" rel="noopener">' . __('Read the documentation', 'fluent-smtp') . '</a>' . __(' for how to configure Postmark with FluentRunSmtp.', 'fluent-smtp')
        ],
        'elasticmail' => [
            'key'      => 'elasticmail',
            ...
            'note'     => '<a href="https://fluentsmtp.com/docs/configure-elastic-email-in-fluent-smtp/" target="_blank" rel="noopener">' . __('Read the documentation', 'fluent-smtp') . '</a>' . __(' for how to configure Elastic Email with FluentRunSmtp.', 'fluent-smtp')
        ],
        'smtp2go'    => [
          'key'      => 'smtp2go',
